...
phenotype[[cols_to_factor]] <- as.factor(phenotype[[cols_to_factor]])
...
for (x in names(data_list)){
  ...
  for (comp in comps){
    ...
    write.csv2(results_chemp_zbmi8, paste0("./results/ExWAS/Mixture_analysis/res_",result_name,"1.csv"))
    write.csv2(data, paste0("./results/ExWAS/Mixture_analysis/data/",result_name,"1.csv"))
    write_rds(data_reg, paste0("./results/ExWAS/Mixture_analysis/data/data_reg_",result_name,"1.RDS"))
    
  }
}

#Forest plot--------------------------------------------------------------------
res_all_prot <- read.csv2("./results/ExWAS/Mixture_analysis/res_data_all_prot1.csv") %>% mutate(Population = "Pooled")
res_all_serum <- read.csv2("./results/ExWAS/Mixture_analysis/res_data_all_serum1.csv")%>% mutate(Population = "Pooled")
res_all_urine <- read.csv2("./results/ExWAS/Mixture_analysis/res_data_all_urine1.csv")%>% mutate(Population = "Pooled")

res_n_prot <- read.csv2("./results/ExWAS/Mixture_analysis/res_data_n_prot1.csv")%>% mutate(Population = "North")
res_n_serum <- read.csv2("./results/ExWAS/Mixture_analysis/res_data_n_serum1.csv")%>% mutate(Population = "North")
res_n_urine <- read.csv2("./results/ExWAS/Mixture_analysis/res_data_n_urine1.csv")%>% mutate(Population = "North")

res_s_prot <- read.csv2("./results/ExWAS/Mixture_analysis/res_data_s_prot1.csv") %>% mutate(Population = "South")
res_s_serum <- read.csv2("./results/ExWAS/Mixture_analysis/res_data_s_serum1.csv")%>% mutate(Population = "South")
res_s_urine <- read.csv2("./results/ExWAS/Mixture_analysis/res_data_s_urine1.csv")%>% mutate(Population = "South")
...
df_prot$Label[df_prot$Label == "" |is.na(df_prot$Label)] <- df_prot$X[df_prot$Label == "" | is.na(df_prot$Label)]
...
write_xlsx(list("Prot"=df_prot,
                "Serum"=df_serum,
                "Urine"=df_urine),
           "./results/ExWAS/Mixture_analysis/bwqs_results.xlsx")
...
ggplot(df_prot[df_prot$X %in% c("Air pollution", "Built environment", "Traffic", "Green spaces and walkability", "Metals", "OCs", "PFAS", "Maternal personal factors", "Diet", "Meteorological factors"),],
...
ggplot(df_serum[df_serum$X %in% c("Air pollution", "Built environment", "Traffic", "Green spaces and walkability", "Metals", "OCs", "PFAS", "Maternal personal factors", "Diet", "Meteorological factors"),],
       aes(y = X, x = mean, xmin = `X2.5.`, xmax = `X97.5.`, shape = Population, colour = Population)) +
  geom_pointrange(size = 0.8, position = position_dodge(width = 0.5)) +
  scale_color_manual(values = colors) + 
...
ggplot(df_urine[df_urine$X %in% c("Air pollution", "Built environment", "Traffic", "Green spaces and walkability", "Metals", "OCs", "PFAS", "Maternal personal factors", "Diet", "Meteorological factors"),],
       aes(y = X, x = mean, xmin = `X2.5.`, xmax = `X97.5.`, shape = Population, colour = Population)) +
  geom_pointrange(size = 0.8, position = position_dodge(width = 0.5)) +
  scale_color_manual(values = colors) + 
...
ggplot(df_prot[df_prot$X %in% mix_name_8, ], aes(
  ...
  scale_fill_manual(values = colors) +
  labs(x = "Exposure", y = "Weights relative to mixture (95% CI)", title = "Maternal personal factors (Prot-LC)") +
  geom_hline(
...
ggplot(df_serum[df_serum$X %in% mix_name_8, ], aes(
  ...
  scale_fill_manual(values = colors) +
  labs(x = "Exposure", y = "Weights relative to mixture (95% CI)", title = "Maternal personal factors (Serum-LC)") +
  geom_hline(
    yintercept = 1 / length(mix_name_8),
    linetype = "dashed",
    color = "black",
...
ggplot(df_urine[df_urine$X %in% mix_name_8, ], aes(
  ...
  scale_fill_manual(values = colors) +
  labs(x = "Exposure", y = "Weights relative to mixture (95% CI)", title = "Maternal personal factors (Urine-LC)") +
  geom_hline(
    yintercept = 1 / length(mix_name_8),
    linetype = "dashed",
    color = "black",
...
pdf("./results/ExWAS/Mixture_analysis/Mix_comp/diet_prot.pdf")
...
pdf("./results/ExWAS/Mixture_analysis/Mix_comp/diet_serum.pdf")
...
pdf("./results/ExWAS/Mixture_analysis/Mix_comp/diet_urine.pdf")
...
pdf("./results/ExWAS/Mixture_analysis/Mix_comp/meteo_prot.pdf")
ggplot(df_prot[df_prot$X %in% mix_name_10, ], aes(
  ...
  scale_fill_manual(values = colors) +
  labs(x = "Exposure", y = "Weights relative to mixture (95% CI)", title = "Meteorological factors (Prot-LC)") +
  geom_hline(
...
pdf("./results/ExWAS/Mixture_analysis/Mix_comp/meteo_serum.pdf")
ggplot(df_serum[df_serum$X %in% mix_name_10, ], aes(
  ...
  scale_fill_manual(values = colors) +
  labs(x = "Exposure", y = "Weights relative to mixture (95% CI)", title = "Meteorological factors (Serum-LC)") +
  geom_hline(
    yintercept = 1 / length(mix_name_10),
    linetype = "dashed",
    color = "black",
...
pdf("./results/ExWAS/Mixture_analysis/Mix_comp/meteo_urine.pdf")
ggplot(df_urine[df_urine$X %in% mix_name_10, ], aes(
  ...
  scale_fill_manual(values = colors) +
  labs(x = "Exposure", y = "Weights relative to mixture (95% CI)", title = "Meteorological factors (Urine-LC)") +
  geom_hline(
    yintercept = 1 / length(mix_name_10),
    linetype = "dashed",
    color = "black",
...
#Maternal personal factors prot
colors <- c(
  "North" = "#3A0417",
  "South" = "#A03358",
  "Pooled" = "#5E0626"
...
p1 <- ggplot(df_prot[df_prot$X %in% mix_name_8, ], aes(
  ...
  scale_fill_manual(values = colors) +
  labs(x = "", y = "Weights relative to mixture (95% CI)", title = "Maternal personal factors (Prot-LC)") +
  geom_hline(
    yintercept = 1 / length(mix_name_8),
    linetype = "dashed",
    color = "black",
...
# Traffic prot
p3 <- ggplot(df_prot[df_prot$X %in% mix_name_3, ], aes(
  x = Label,
  y = mean,
  fill = Population
)) +
  ...
  scale_fill_manual(values = colors) +
  labs(x = "", y = "Weights relative to mixture (95% CI)", title = "Traffic (Prot-LC)") +
  geom_hline(
    yintercept = 1 / length(mix_name_3),
    linetype = "dashed",
    color = "black",
    size = 0.1
  ) +
...
p4 <- ggplot(df_serum[df_serum$X %in% mix_name_5, ], aes(
  x = Label,
  y = mean,
  fill = Population
)) +
...
p5 <- ggplot(df_serum[df_serum$X %in% mix_name_4, ], aes(
  x = Label,
  y = mean,
  fill = Population
)) +
...
p6 <- ggplot(df_urine[df_urine$X %in% mix_name_9, ], aes(
  x = Label,
  y = mean,
  fill = Population
)) +
...
p1 <- ggplot(df_prot[df_prot$X %in% c("Air pollution", "Built environment", "Traffic", "Green spaces and walkability", "Metals", "OCs", "PFAS", "Maternal personal factors", "Diet", "Meteorological factors"),],
             aes(y = X, x = mean, xmin = `X2.5.`, xmax = `X97.5.`, shape = Population, colour = Population)) +
  geom_pointrange(size = 0.8, position = position_dodge(width = 0.5)) +
  scale_color_manual(values = colors) + 
...
p2 <- ggplot(df_serum[df_serum$X %in% c("Air pollution", "Built environment", "Traffic", "Green spaces and walkability", "Metals", "OCs", "PFAS", "Maternal personal factors", "Diet", "Meteorological factors"),],
             aes(y = X, x = mean, xmin = `X2.5.`, xmax = `X97.5.`, shape = Population, colour = Population)) +
  geom_pointrange(size = 0.8, position = position_dodge(width = 0.5)) +
  scale_color_manual(values = colors) + 
...
p3 <- ggplot(df_urine[df_urine$X %in% c("Air pollution", "Built environment", "Traffic", "Green spaces and walkability", "Metals", "OCs", "PFAS", "Maternal personal factors", "Diet", "Meteorological factors"),],
             aes(y = X, x = mean, xmin = `X2.5.`, xmax = `X97.5.`, shape = Population, colour = Population)) +
  geom_pointrange(size = 0.8, position = position_dodge(width = 0.5)) +
  scale_color_manual(values = colors) + 
...
prep_table <- function(df, mix, group_name) {
  df %>%
    filter(X %in% mix) %>%
    select(Label, Population, mean, `X2.5.`, `X97.5.`) %>%
    rename(
      Exposure = Label,
      `Lower 95% CI` = `X2.5.`,
      `Upper 95% CI` = `X97.5.`
    ) %>%
    mutate(Group = group_name, .before = Exposure)
}

# Build one big table
all_tables <- bind_rows(
  prep_table(df_prot, mix_name_8, "Maternal personal factors (Prot-LC)"),
  prep_table(df_prot, mix_name_4, "Green spaces and walkability (Prot-LC)"),
  prep_table(df_prot, mix_name_3, "Traffic (Prot-LC)"),
  prep_table(df_serum, mix_name_5, "Metals (Serum-LC)"),
  prep_table(df_serum, mix_name_4, "Green spaces and walkability (Serum-LC)"),
  prep_table(df_urine, mix_name_9, "Diet (Urine-LC)")
)

# Show nicely
knitr::kable(all_tables, digits = 3, align = "c",
             caption = "Mixture analysis results (weights relative to mixture, 95% CI)")


wb <- createWorkbook()
addWorksheet(wb, "All Results")
writeData(wb, "All Results", all_tables)

saveWorkbook(wb, "./results/ExWAS/Mixture_analysis/Mixture_results_table.xlsx", overwrite = TRUE)
