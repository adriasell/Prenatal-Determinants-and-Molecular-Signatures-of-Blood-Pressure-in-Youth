...
ggplot(df_prot[df_prot$X %in% c("Air pollution", "Built environment", "Traffic", "Green spaces and walkability", "Metals", "OCs", "PFAS", "Lifestyle factors", "Demographic factors", "Diet"),],
