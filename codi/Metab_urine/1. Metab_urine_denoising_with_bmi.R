...
setwd("./TFM")
output_path <- "./results/sensitivity_bmi"
getwd()
...
omicFile <- "./results/denoising/denoising_metab/urine/urine_winsorized.RDS"
...
pData(omics$data)["hs2_zbmi_who_Time1"] <- round(pData(omics$data)$hs2_zbmi_who_Time1, 3)
...
denoise_vars <- c("e3_bw", "hs2_visit_age_years_Time1", "e3_sex","h_ethnicity_c_Asian_pakistani",
                  "h_ethnicity_c_Caucasian",'cohort_BIB', "cohort_EDEN", "cohort_KANC", "cohort_MOBA","cohort_SAB", "hs2_zbmi_who_Time1")
